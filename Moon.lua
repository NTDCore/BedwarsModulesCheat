...
runcode(function()
	...
	local anims = {
		...
		ZylaAnim = {
			{CFrame = CFrame.new(0, -0, 0) * CFrame.Angles(-math.rad(190), math.rad(110), -math.rad(90)), Time = 0.27},
			{CFrame = CFrame.new(0.3, -1.5, 1.5) * CFrame.Angles(math.rad(120), math.rad(140), math.rad(320)), Time = 0.27}
		},
	}
  ...
  --[[  killauratargets = Killaura.CreateSlider({
    ...
    killauraanimmethod = Killaura.CreateDropdown({
        ["Name"] = "Animation", 
        ["List"] = {"Normal", "Slow", "New", "Vertical Spin", "Exhibition", "Exhibition Old", "OldAstralAnim", "ZylaAnim"},
        ["Function"] = function(val) end
    })
...
local funnyAura = false

runcode(function()
    local part
    funnyFly = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
        ["Name"] = "FunnyFly",
        ["HoverText"] = "Infinite Fly",
        ["Function"] = function(callback)
            if callback then
                if funnyAura then funnyAura(false) end
...
local TpBounceFly = {["Enabled"] = false}
	TpBounceFly = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
    	["Name"] = "TpBounceFly",
