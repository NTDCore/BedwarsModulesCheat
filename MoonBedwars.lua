...
endlocal lplr = game.Players.LocalPlayer
...
local bedwars = {
	...
	["CombatConstant"] = require(repstorage.TS.All["All-constant"]).CombatConstant,
...
local XylexTexturePack = windowapi.CreateButton({
	...
	["Function"] = function(callback)
		...
		targetblock.Color = Color3.fromRGB(102,0,255)
		...
		if breaknotification == false then
		breaknotification = true
		notification("Bed Breaking", "gonna fuck the bed", 2)
		spawn(function()
			task.wait(3)
...
fucker = nil
local Bedfu = windowapi.CreateButton({
	["Name"] = "NukerBed",
	["Tab"] = "All",
	["Function"] = function(callback)
		if callback then
